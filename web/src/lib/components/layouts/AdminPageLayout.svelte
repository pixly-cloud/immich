...
<AppShell>
  ...
  >
    <div class="flex flex-col gap-1 pe-4 pt-8">
      ...
      <!-- Pixly: external libraries are managed by the platform and hidden from tenants -->
      ...
      <!-- Pixly: system settings & maintenance are managed by the platform and hidden from tenants -->
